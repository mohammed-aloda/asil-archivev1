...
const Checkout: React.FC = () => {
        ...
        return (
            <div className="min-h-screen pt-32 pb-20 px-6 flex flex-col items-center justify-center text-center">
                <div className="max-w-lg mx-auto">
                    <CheckCircle
                        size={72}
                        className="mx-auto mb-8 text-asl-gold"
                        strokeWidth={1}
                    />
                    <h1 className="text-4xl font-serif text-asl-espresso mb-4">
                        Thank You for Your Order
                    </h1>
                    <p className="text-asl-espresso/60 text-sm leading-relaxed mb-10">
                    ...
                    <Link
                        to="/shop"
                        className="inline-block text-xs uppercase tracking-widest border-b border-asl-espresso pb-1 hover:text-asl-gold hover:border-asl-gold transition-colors text-asl-espresso"
                    >
                        Continue Shopping
                    </Link>
                </div>
        ...
        return (
            <div className="min-h-screen pt-32 pb-20 px-6 flex flex-col items-center justify-center text-center">
                <div className="max-w-lg mx-auto">
                    <XCircle
                        size={64}
                        className="mx-auto mb-8 text-asl-espresso/40"
                        strokeWidth={1}
                    />
                    <h2 className="text-3xl font-serif text-asl-espresso mb-4">
                        Payment Canceled
                    </h2>
                    <p className="text-asl-espresso/60 text-sm mb-10">
    ...
    if (cart.length === 0) {
        return (
            <div className="min-h-screen pt-32 px-6 text-center">
                <h2 className="text-3xl font-serif text-asl-espresso mb-4">Your Cart is Empty</h2>
    ...
    return (
        <div className="min-h-screen pt-28 pb-20 px-6 max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl font-serif text-asl-espresso mb-12 text-center">Checkout</h1>

            <div className="max-w-3xl mx-auto">
                {/* Order Summary */}
                <div className="bg-asl-stone/5 p-8 rounded-sm mb-8">
                    <h2 className="text-xl font-serif text-asl-espresso mb-6">Order Summary</h2>
                        ...
                        {cart.map((item) => (
                            <div key={`${item.id}-${item.size}`} className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-serif text-asl-espresso text-sm">{item.name}</h3>
                    ...
                    <div className="border-t border-asl-espresso/10 pt-6 space-y-2">
                    ...
                    <div className="border-t border-asl-espresso/10 mt-4 pt-4 flex justify-between items-center">
                ...
                <div className="text-center">
                    ...
                    <button
                        ...
                        className={`w-full py-5 bg-asl-espresso text-white uppercase tracking-widest text-sm hover:bg-asl-gold transition-all flex items-center justify-center gap-3 btn-press shadow-lg ${isProcessing ? 'opacity-70 cursor-wait' : ''}`}
                    >
