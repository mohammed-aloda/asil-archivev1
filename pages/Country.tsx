...
const CountryPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-asl-cream">
            <main className="pt-24 pb-16 px-4 md:px-8">
                <div className="max-w-6xl mx-auto">
                    {/* Back button */}
                    <Link
                        to="/"
                        className="inline-flex items-center gap-2 text-asl-espresso hover:text-asl-gold transition-colors mb-8"
                    >
                    ...
                    <div className="space-y-6 mb-16">
                        <div className="space-y-2">
                            <p className="text-xs uppercase tracking-[0.5em] text-asl-gold font-semibold">
                                Heritage Collection
                            </p>
                            <h1 className="text-5xl md:text-7xl font-serif text-asl-espresso">
                                {countryName}
                            </h1>
                        </div>
                        <p className="text-lg md:text-xl text-asl-espresso/80 max-w-3xl">
                            Discover the cultural heritage and unique jerseys inspired by {countryName}'s rich history and traditions.
                        </p>
                    </div>

                    {/* Coming Soon Section */}
                    <div className="bg-white rounded-lg border-2 border-asl-espresso/20 p-12 text-center">
                        <div className="max-w-2xl mx-auto space-y-6">
                            ...
                            <h2 className="text-3xl font-serif text-asl-espresso">
                                Coming Soon
                            </h2>

                            <p className="text-base text-asl-espresso/70">
                            ...
                            <div className="pt-4">
                                <Link
                                    to="/shop/cultural"
                                    className="inline-block px-8 py-3 border-2 border-asl-espresso text-asl-espresso hover:bg-asl-espresso hover:text-asl-cream transition-all duration-300 uppercase tracking-widest text-sm font-semibold"
                                >
                    ...
                    <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="text-center space-y-3">
                            ...
                            <h3 className="font-serif text-xl text-asl-espresso">
                                Authentic Heritage
                            </h3>
                            <p className="text-sm text-asl-espresso/70">
