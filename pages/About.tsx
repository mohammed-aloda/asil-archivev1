...
const AboutUs: React.FC = () => {
    return (
        <div className="min-h-screen w-full relative transition-colors duration-500 bg-asl-cream overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto px-8 py-24 relative z-10">
                ...
                <section className="mb-24 text-center space-y-8">
                    <h1 className="text-5xl md:text-7xl font-serif text-asl-espresso italic">
                        The Beauty of Confusion
                    </h1>
                    <div className="space-y-6 max-w-2xl mx-auto text-lg leading-relaxed text-asl-espresso/90 font-light">
                        <p>
                ...
                <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
                    <div className="space-y-6">
                        <h3 className="text-3xl font-serif text-asl-espresso">
                            Unity Through Uniqueness
                        </h3>
                        <p className="text-base leading-relaxed text-asl-espresso/90 font-light">
                    ...
                    <div className="relative p-8 border border-asl-gold/20 bg-asl-cream/30 backdrop-blur-sm">
                ...
                {/* Section 3: The Goal */}
                <section className="text-center space-y-12 bg-asl-espresso/5 p-12 rounded-sm border border-asl-gold/10">
                    <h3 className="text-sm uppercase tracking-[0.5em] text-asl-gold font-sans font-semibold">
                        The Goal
                    </h3>
                    <h2 className="text-4xl font-serif text-asl-espresso">
                        Confidence in Representation
                    </h2>
                    <p className="max-w-2xl mx-auto text-base leading-relaxed text-asl-espresso/90 font-light">
                ...
                <div className="mt-24 text-center">
                    <button className="px-12 py-5 border-2 border-asl-espresso text-asl-espresso hover:bg-asl-espresso hover:text-asl-cream transition-all duration-500 font-sans uppercase tracking-[0.3em] text-xs font-bold">
                        Find Your Origin
                    </button>
                </div>
            </div>
